...
namespace nio2so.Voltron.PreAlpha.Protocol.PDU.Datablob.Structures
{
    /// <summary>
    ...
    /// </summary>
    [TSOVoltronDatablobContent((uint)TSO_PreAlpha_MasterConstantsTable.GZCLSID_cCrDMStandardMessage)]
