...
namespace nio2so.Voltron.PreAlpha.Protocol.PDU
{
    ...
    /// Verified
    /// </summary>
    [TSOVoltronPDU((uint)TSO_PreAlpha_VoltronPacketTypes.CREATE_AND_JOIN_ROOM_PDU)]
    ...
    [TSOVoltronPDU((uint)TSO_PreAlpha_VoltronPacketTypes.CREATE_ROOM_RESPONSE_PDU)]
