...
{
    [TSOVoltronDBRequestWrapperPDU((uint)TSO_PreAlpha_DBActionCLSIDs.UpdateLotValueByID_Request)]
    public class TSOUpdateLotValueByIDRequest : TSODBRequestWrapper
    {
