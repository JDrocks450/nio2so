...
namespace nio2so.Voltron.PreAlpha.Protocol.PDU.DBWrappers
{
    ...
    /// </summary>
    [TSOVoltronDBRequestWrapperPDU((uint)TSO_PreAlpha_DBActionCLSIDs.BuyLotByAvatarID_Request)]
    public class TSOBuyLotByAvatarIDRequest : TSODBRequestWrapper
    {
        /// <summary>
        /// The Index of the cell in the World Grid
        /// </summary>
        [TSOVoltronDBWrapperField][TSOVoltronString(TSOVoltronValueTypes.Length_Prefixed_Byte)] public string HouseIDString { get; set; }
        /// <summary>
