...
namespace nio2so.Voltron.PreAlpha.Protocol.Regulator
{
    ...
    internal class AvatarProtocol : TSOProtocol
    {
        ...
        [TSOProtocolDatabaseHandler((uint)TSO_PreAlpha_DBActionCLSIDs.GetCharByID_Request)]
        ...
        /// <exception cref="InvalidDataException"></exception>    
        /// <exception cref="InvalidDataException"></exception>
        [TSOProtocolDatabaseHandler((uint)TSO_PreAlpha_DBActionCLSIDs.SetCharByID_Request)]
        public void SetCharByID_Request(TSODBRequestWrapper PDU)
        {
            ...
            //log this to disk
            Logger.OnCharData(NetworkTrafficDirections.INBOUND, avatarID, charData);
        ...
        /// <exception cref="InvalidDataException"></exception>
        [TSOProtocolDatabaseHandler((uint)TSO_PreAlpha_DBActionCLSIDs.GetCharBlobByID_Request)]
        public void GetCharBlobByID_Request(TSODBRequestWrapper PDU)
        {
            ...
            Logger.OnCharBlob(NetworkTrafficDirections.OUTBOUND, avatarID, charBlob);
        ...
        /// </summary>
        /// <param name="PDU"></param>
        [TSOProtocolDatabaseHandler((uint)TSO_PreAlpha_DBActionCLSIDs.GetBookmarks_Request)]
        ...
        /// </summary>
        /// <param name="PDU"></param>
        [TSOProtocolDatabaseHandler((uint)TSO_PreAlpha_DBActionCLSIDs.SetBookmarks_Request)]
        ...
        /// <param name="PDU"></param>
        /// <exception cref="InvalidDataException"></exception>        
        [TSOProtocolDatabaseHandler((uint)TSO_PreAlpha_DBActionCLSIDs.InsertNewCharBlob_Request)]
        ...
        /// <param name="PDU"></param>
        /// <exception cref="InvalidDataException"></exception>        
        [TSOProtocolDatabaseHandler((uint)TSO_PreAlpha_DBActionCLSIDs.SetCharBlobByID_Request)]
        ...
        void UploadCharacterBlob(uint avatarID, TSODBCharBlob Blob)
        {
            ...
            Logger.OnCharBlob(NetworkTrafficDirections.INBOUND, avatarID, Blob);            
        }
        ...
        /// </summary>
        /// <param name="PDU"></param>
        [TSOProtocolDatabaseHandler((uint)TSO_PreAlpha_DBActionCLSIDs.DebitCredit_Request)]
        ...
        /// <param name="PDU"></param>
        /// <exception cref="InvalidDataException"></exception>
        [TSOProtocolDatabaseHandler((uint)TSO_PreAlpha_DBActionCLSIDs.SetMoneyFields_Request)]
        ...
        [TSOProtocolDatabaseHandler((uint)TSO_PreAlpha_DBActionCLSIDs.GetRelationshipsByID_Request)]
        ...
        [TSOProtocolDatabaseHandler((uint)TSO_PreAlpha_DBActionCLSIDs.GetReversedRelationshipsByID_Request)]
        ...
        [TSOProtocolHandler((uint)TSO_PreAlpha_VoltronPacketTypes.FIND_PLAYER_PDU)]
        public void FIND_PLAYER_PDU(TSOVoltronPacket PDU)
        {
            ...
            var status = IsOnline ? TSOStatusReasonStruct.Online : TSOStatusReasonStruct.Offline;
            ...
            Logger.LogConsole(new(TSOLoggerServiceBase.LogSeverity.Message, RegulatorName, $"FIND PLAYER: {AvatarID}"));                
            return;
        error:
            Logger.LogConsole(new(TSOLoggerServiceBase.LogSeverity.Message,
