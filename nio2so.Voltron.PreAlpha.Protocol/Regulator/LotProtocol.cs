...
namespace nio2so.Voltron.PreAlpha.Protocol.Regulator
{
    ...
    {    
        ...
        /// <exception cref="NullReferenceException"></exception>
        [TSOProtocolDatabaseHandler((uint)TSO_PreAlpha_DBActionCLSIDs.BuyLotByAvatarID_Request)]
        public void BuyLotByAvatarID_Request(TSODBRequestWrapper PDU)
        {
            void Failed(string error)
            {
                LogConsole(error, nameof(BuyLotByAvatarID_Request), TSOLoggerServiceBase.LogSeverity.Errors);
        ...
        /// <param name="PDU"></param>
        /// <exception cref="NullReferenceException"></exception>
        [TSOProtocolDatabaseHandler((uint)TSO_PreAlpha_DBActionCLSIDs.GetRoommateInfoByLotID_Request)]
        ...
        /// <param name="PDU"></param>
        /// <exception cref="NullReferenceException"></exception>
        [TSOProtocolDatabaseHandler((uint)TSO_PreAlpha_DBActionCLSIDs.GetLotList_Request)]
        ...
        /// <param name="PDU"></param>
        /// <exception cref="NullReferenceException"></exception>
        [TSOProtocolDatabaseHandler((uint)TSO_PreAlpha_DBActionCLSIDs.GetLotByID_Request)]
        ...
        /// </summary>
        /// <param name="PDU"></param>
        [TSOProtocolDatabaseHandler((uint)TSO_PreAlpha_DBActionCLSIDs.GetHouseThumbByID_Request)]
        ...
        /// </summary>
        /// <param name="PDU"></param>
        [TSOProtocolDatabaseHandler((uint)TSO_PreAlpha_DBActionCLSIDs.SetHouseThumbByID_Request)]
        ...
        /// <param name="PDU"></param>
        /// <exception cref="NullReferenceException"></exception>
        [TSOProtocolDatabaseHandler((uint)TSO_PreAlpha_DBActionCLSIDs.GetHouseBlobByID_Request)]
        ...
        [TSOProtocolDatabaseHandler((uint)TSO_PreAlpha_DBActionCLSIDs.SetHouseBlobByID_Request)]
        ...
        { // client is giving us house blob data
            ...
            if (!Result)
                LogConsole(Reason, nameof(SetHouseBlobByID_Request), TSOLoggerServiceBase.LogSeverity.Errors);
            Logger.OnHouseBlob(NetworkTrafficDirections.INBOUND, HouseID, new(housChunk.Content));
        }
        /// <summary>
        ...
        /// <exception cref="NullReferenceException"></exception>
        // The Client is requesting to set the house data for this HouseID in the Database
        [TSOProtocolDatabaseHandler((uint)TSO_PreAlpha_DBActionCLSIDs.SetLotByID_Request)]
