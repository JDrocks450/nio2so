...
namespace nio2so.Voltron.NewImproved.Protocol.PDU
{
    ...
    /// </summary>
    [TSOVoltronPDU((uint)TSO_NewImproved_VoltronPacketTypes.HostOnlinePDU)]
    public class TSOHostOnlinePDU : TSOVoltronPacket
    {
        ...
        public override ushort VoltronPacketType => (ushort)TSO_NewImproved_VoltronPacketTypes.HostOnlinePDU;        
