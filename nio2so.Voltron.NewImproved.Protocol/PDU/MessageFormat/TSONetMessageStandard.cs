...
namespace nio2so.Voltron.NewImproved.Protocol.PDU.MessageFormat
{
    ...
    /// <summary>
    /// Represents a <see cref="TSO_NewImproved_VoltronPacketTypes_MsgCLSIDs.cTSONetMessageStandard"/> which is the most common type
    /// </summary>
    public record TSONetMessageStandard : ITSOMessage
    {
        ...
        /// </summary>
        public TSO_NewImproved_VoltronPacketTypes_MsgCLSIDs kMSG { get; set; }                
        /// <summary>
        /// The string entry in the TSODataDefinition corresponding with this query
        /// </summary>
        public TSONewImprovedTSODataEnum DataDefinitionID { get; set; }
        /// <summary>
        ...
        [TSOVoltronIgnorable]
        [IgnoreDataMember]
        public TSO_NewImproved_VoltronPacketTypes_MsgCLSIDs? EmbeddedMessageCLSID { get; set; }
        [TSOVoltronIgnorable]
        [IgnoreDataMember]
        ...
        private void ReadMessageData()
        {
            ...
            if ((Flags & (1 << 5)) != 0)
            {
                EmbeddedMessageCLSID = (TSO_NewImproved_VoltronPacketTypes_MsgCLSIDs)readUInt(Endianness.BigEndian);
