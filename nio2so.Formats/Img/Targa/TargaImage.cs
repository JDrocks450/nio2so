...
namespace nio2so.Formats.Img.Targa
{
    /// <summary>
...

    {
        ...
        {
            get { return objTargaExtensionArea; }
        }
            ...
            if (binReader != null && binReader.BaseStream != null && binReader.BaseStream.Length > 0 && binReader.BaseStream.CanSeek == true)
            {
                ...
                if (objTargaFooter.ExtensionAreaOffset > 0)
                {
                    try
                    {
                        ...
                        objTargaExtensionArea.SetExtensionSize(binReader.ReadInt16());
                        ...
                        if (DateTime.TryParse(strStamp, out dtstamp) == true)
                            objTargaExtensionArea.SetDateTimeStamp(dtstamp);
                        ...
                        objTargaExtensionArea.SetPixelAspectRatioNumerator(binReader.ReadInt16());
                        objTargaExtensionArea.SetPixelAspectRatioDenominator(binReader.ReadInt16());
                        objTargaExtensionArea.SetGammaNumerator(binReader.ReadInt16());
                        objTargaExtensionArea.SetGammaDenominator(binReader.ReadInt16());
                        ...
                        objTargaExtensionArea.SetAttributesType(binReader.ReadByte());
        ...
        private void LoadTGAImage(BinaryReader binReader)
        {
            ...
            intStride = (objTargaHeader.Width * objTargaHeader.PixelDepth + 31 & ~31) >> 3; // width in bytes

            // calculate the padding, in bytes, of the image 
            // number of bytes to add to make each row a 32bit aligned row
            // padding in bytes
            intPadding = intStride - (objTargaHeader.Width * objTargaHeader.PixelDepth + 7) / 8;
            ...
            bmpTargaImage = new Bitmap(objTargaHeader.Width,
            ...
            if (objTargaHeader.ColorMap.Count > 0)
            {
                ...
                for (int i = 0; i < objTargaHeader.ColorMap.Count; i++)
                {
                    ...
                    if (Format == TGAFormat.NEW_TGA && objTargaFooter.ExtensionAreaOffset > 0)
                    {
        ...
        protected virtual void Dispose(bool disposing)
        {
            ...
            if (!disposed)
            {
                ...
                if (disposing)
                {
                    ...
                    if (objTargaHeader != null)
                    {
                        objTargaHeader.ColorMap.Clear();
                        objTargaHeader = null;
                    }
                    if (objTargaExtensionArea != null)
                    {
    ...
    public class TargaHeader
    {
        ...
        {
            get { return sColorMapFirstEntryIndex; }
        }
        ...
        {
            get { return eVerticalTransferOrder; }
        }
        ...
        {
            get { return eHorizontalTransferOrder; }
        }
    ...
    public class TargaFooter
    {
        ...
        {
            get { return intExtensionAreaOffset; }
        }
        ...
        {
            get { return intDeveloperDirectoryOffset; }
        }
        ...
        {
            get { return strReservedCharacter; }
        }
    ...
    public class TargaExtensionArea
    {
        ...
        {
            get { return intPixelAspectRatioNumerator; }
        }
        ...
        {
            get { return intPixelAspectRatioDenominator; }
        }
        ...
        public float PixelAspectRatio
        {
            get
            {
                ...
                {
                    return intPixelAspectRatioNumerator / (float)intPixelAspectRatioDenominator;
                }
                else
                    return 0.0F;
            }
        ...
        {
            get { return intGammaDenominator; }
        }
        ...
        public float GammaRatio
        {
            get
            {
                ...
                {
                    float ratio = intGammaNumerator / (float)intGammaDenominator;
        ...
        {
            get { return intColorCorrectionOffset; }
        }
        ...
        {
            get { return intPostageStampOffset; }
        }
        ...
        {
            get { return cColorCorrectionTable; }
        }
